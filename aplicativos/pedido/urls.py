...
from aplicativos.pedido.views import index, pedido, imagem_prato, imagem_bebida, adicionar_prato_a_comanda, adicionar_bebida_a_comanda, limpar_comanda #somar_valores
...
urlpatterns = [
    ...
    # path('somar_valores/<int:mesa_id>', somar_valores, name='somar_valores'),
]
